  ...
  return (
    <Box {...other}>
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1166.17 805.09">
        ...
        <ellipse cx="639.99" cy="849.64" rx="335.02" ry="16.83" fill={PRIMARY_MAIN} opacity="0.1" />
        <path
          ...
          fill={PRIMARY_MAIN}
        />
        <ellipse cx="237.04" cy="854.65" rx="29.92" ry="5.06" fill={PRIMARY_MAIN} opacity="0.1" />
        <path
          ...
          fill={PRIMARY_MAIN}
        />
        <ellipse cx="175.67" cy="839.97" rx="16.87" ry="2.85" fill={PRIMARY_MAIN} opacity="0.1" />
        <path
          ...
          fill={PRIMARY_MAIN}
        />
        <ellipse cx="217.64" cy="808.92" rx="20.37" ry="3.44" fill={PRIMARY_MAIN} opacity="0.1" />
        <path
